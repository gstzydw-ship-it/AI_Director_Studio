...
output_contract: "根据变化类型选择衔接词：保持、切至、切近、拉开或固定视角保持人物进出。"
...
## 规则内容
将镜头衔接词严格分成四类：
1. **镜头保持在 A 身上**：同主体、同景别基底或同视角、动作继续。
2. **镜头切至 B**：主体变化，必须显式切镜。
3. **镜头切近 / 拉开至 A 的某个景别**：同主体，但景别变化。
4. **固定视角保持，A/B 进入或离开画面**：场景视角不变，人物在画内运动。

## 硬规则
1. 主体变化必须明确写“镜头切至/镜头切到/镜头转向”新主体，不能拿笼统话术糊过去。
2. “同一机位继续”只作为内部问题识别词；最终 prompt 应改写为同主体动作续接、固定场景视角保持或双人关系景保持。
3. 即使是延续，也优先写“镜头保持在A身上”“双人关系景保持”“电梯口固定视角保持”，少写泛泛的“同一机位继续”。
