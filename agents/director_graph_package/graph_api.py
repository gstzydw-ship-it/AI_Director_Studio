...
def create_director_graph():
    ...
    graph.add_node("story_planner", rhythm_story_planner_node)
    ...
    graph.add_edge("director_showrunner", "story_planner")
    graph.add_edge("story_planner", "wait_for_segment_request")
